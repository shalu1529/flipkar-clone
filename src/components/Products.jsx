...
//             // Filter out products that are not in the "clothing" category
//             const clothingProducts = data.filter(product => product.category === "men's clothing" || product.category === "women's clothing");
